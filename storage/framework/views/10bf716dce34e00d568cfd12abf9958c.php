<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(url('/etkinlikler?source_type=user')); ?>" 
            ...
            <a href="<?php echo e(url('/etkinlikler?source_type=official')); ?>" 
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-16">
                ...
                <div class="mt-8 md:mt-0">
                    <a href="<?php echo e(url('/etkinlikler')); ?>" class="inline-flex items-center gap-2 text-sm font-black tracking-widest uppercase text-[#1a1a1a] border-b-2 border-[#ff5528] pb-1 hover:text-[#ff5528] transition-all">
                        TÜM AKTİVİTELER →
                    </a>
                </div>
            </div>
            ...
            <div class="swiper featured-events-swiper !pb-20">
                <div class="swiper-wrapper">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $latestEtkinlikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etkinlik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\planify\resources\views/home.blade.php ENDPATH**/ ?>