            ...
            <div class="flex items-center justify-between h-16">
                ...
                <ul role="list" class="hidden md:flex items-center gap-8 list-none m-0 p-0">
                    ...
                    <li>
                        <a href="<?php echo e(route('contact')); ?>"
                           aria-current="<?php echo e(request()->routeIs('contact') ? 'page' : 'false'); ?>"
                           class="text-sm font-bold uppercase tracking-widest transition-colors
                                  <?php echo e(request()->routeIs('contact') ? 'text-[#ff5528]' : 'text-gray-600 hover:text-[#ff5528]'); ?>">
                            İletişim
                        </a>
                    </li>
                </ul>
                ...
                <div class="flex items-center gap-4">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->is_admin || auth()->user()->role === 'admin'): ?>
            ...
            <ul role="list" class="list-none m-0 p-0 px-6 py-4 space-y-1">
                ...
                <li>
                    <a href="<?php echo e(route('contact')); ?>"
                       aria-current="<?php echo e(request()->routeIs('contact') ? 'page' : 'false'); ?>"
                       class="block px-4 py-3 rounded-lg text-sm font-bold uppercase tracking-widest transition-colors
                              <?php echo e(request()->routeIs('contact') ? 'bg-[#ff5528]/10 text-[#ff5528]' : 'text-gray-600 hover:bg-gray-50 hover:text-[#ff5528]'); ?>">
                        İletişim
                    </a>
                </li>
                <?php if(auth()->guard()->check()): ?>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-gray-800/80">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <a href="<?php echo e(route('home')); ?>" class="inline-block text-3xl font-black tracking-tight text-white">
                        Plan<span class="text-[#ff5528]">ify</span>
                    </a>
                    <p class="text-gray-400 text-sm leading-relaxed max-w-sm font-medium">
                        <?php echo e($siteSettings['footer_about'] ?? 'Şehrin ritmini yakala, yeni deneyimler keşfet ve toplulukla buluş. En güncel konserler, tiyatrolar, atölyeler ve sosyal planlar tek bir platformda.'); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <?php if(!empty($siteSettings['social_instagram'])): ?>
                                <a href="<?php echo e($siteSettings['social_instagram']); ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                            ...
                            <?php if(!empty($siteSettings['social_twitter'])): ?>
                                <a href="<?php echo e($siteSettings['social_twitter']); ?>" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)"
                                   class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:border-[#ff5528] hover:bg-[#ff5528] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 group">
                            ...
                            <?php if(!empty($siteSettings['social_youtube'])): ?>
                                <a href="<?php echo e($siteSettings['social_youtube']); ?>" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
                                   class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:border-[#ff5528] hover:bg-[#ff5528] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 group">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if(!empty($siteSettings['social_linkedin'])): ?>
                                <a href="<?php echo e($siteSettings['social_linkedin']); ?>" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                                   class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:border-[#ff5528] hover:bg-[#ff5528] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 group">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if(!empty($siteSettings['social_facebook'])): ?>
                                <a href="<?php echo e($siteSettings['social_facebook']); ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                                   class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:border-[#ff5528] hover:bg-[#ff5528] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 group">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if(!empty($siteSettings['social_tiktok'])): ?>
                                <a href="<?php echo e($siteSettings['social_tiktok']); ?>" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                                   class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 hover:border-[#ff5528] hover:bg-[#ff5528] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 group">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li>
                            <a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium flex items-center gap-2">
                                <span class="text-[#ff5528] text-xs">›</span> Ana Sayfa
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index')); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium flex items-center gap-2">
                                <span class="text-[#ff5528] text-xs">›</span> Tüm Etkinlikler
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['source_type' => 'user'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium flex items-center gap-2">
                                <span class="text-[#ff5528] text-xs">›</span> Sosyal Rehber (Planlar)
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['source_type' => 'official'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium flex items-center gap-2">
                                <span class="text-[#ff5528] text-xs">›</span> Şehir Duyuruları
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('contact')); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium flex items-center gap-2">
                                <span class="text-[#ff5528] text-xs">›</span> İletişim & Destek
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.create')); ?>" class="text-[#ff5528] hover:text-white transition-colors font-bold flex items-center gap-2">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['category' => 'Konser & Canlı Müzik'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium">
                                🎵 Konser & Canlı Müzik
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['category' => 'Tiyatro & Gösteri'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium">
                                🎭 Tiyatro & Gösteri
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['category' => 'Sergi & Kültür-Sanat'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium">
                                🎨 Sergi & Sanat
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['category' => 'Festival & Açık Hava'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium">
                                🎪 Festival & Açık Hava
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('etkinlikler.index', ['category' => 'Atölye & Workshop'])); ?>" class="text-gray-400 hover:text-[#ff5528] transition-colors font-medium">
                                💡 Atölye & Workshop
                            </a>
                        </li>
                    </ul>
                ...
                <div class="space-y-4">
                    ...
                    <div class="pt-2 text-[11px] text-gray-500 flex flex-col gap-1">
                        <div class="flex items-center gap-1.5">
                            <span>📍</span>
                            <span class="truncate"><?php echo e($siteSettings['contact_address'] ?? 'İstanbul, Türkiye'); ?></span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span>✉️</span>
                            <a href="mailto:<?php echo e($siteSettings['contact_email'] ?? 'destek@planify.com'); ?>" class="hover:text-[#ff5528] transition-colors"><?php echo e($siteSettings['contact_email'] ?? 'destek@planify.com'); ?></a>
                        </div>
                        <?php if(!empty($siteSettings['contact_phone'])): ?>
                            <div class="flex items-center gap-1.5">
                                <span>📞</span>
                                <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $siteSettings['contact_phone'])); ?>" class="hover:text-[#ff5528] transition-colors"><?php echo e($siteSettings['contact_phone']); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
                <p class="font-medium">
                    © <?php echo e(date('Y')); ?> <span class="text-white font-bold">Planify</span>. Tüm hakları saklıdır.
                </p>

                <div class="flex flex-wrap items-center gap-6 font-medium">
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-[#ff5528] transition-colors">Kullanım Koşulları</a>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-[#ff5528] transition-colors">Gizlilik Politikası</a>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-[#ff5528] transition-colors">Çerez Politikası</a>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-[#ff5528] transition-colors">KVKK</a>
                </div>
            </div>
        </div>
    </footer>
