...
<div class="max-w-4xl">
    <div class="bg-white rounded-[40px] border border-gray-100 shadow-sm overflow-hidden">
        <div class="p-10 border-b border-gray-50 bg-gray-50/50">
            <h3 class="text-xl font-black font-heading uppercase tracking-tight text-[#0f172a]">Slider Düzenle</h3>
            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-2">Mevcut slider bilgilerini güncelleyin.</p>
        </div>

        <form action="<?php echo e(route('admin.sliders.update', $slider)); ?>" method="POST" enctype="multipart/form-data" class="p-10 space-y-8">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <select name="page" class="w-full bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 text-sm font-bold text-[#0f172a] focus:ring-2 focus:ring-primary focus:border-primary transition-all">
                        <option value="home" <?php echo e(old('page', $slider->page) == 'home' ? 'selected' : ''); ?>>Anasayfa</option>
                        <option value="kesfet" <?php echo e(old('page', $slider->page) == 'kesfet' ? 'selected' : ''); ?>>Keşfet</option>
                        <option value="both" <?php echo e(old('page', $slider->page) == 'both' ? 'selected' : ''); ?>>Her İki Sayfa</option>
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="url" name="link" value="<?php echo e(old('link', $slider->link)); ?>" 
                        class="w-full bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 text-sm font-bold text-[#0f172a] focus:ring-2 focus:ring-primary focus:border-primary transition-all">
            ...
            <div class="space-y-4">
                ...
                <div class="relative group">
                    ...
                    <label for="imageInput" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-gray-200 rounded-[32px] bg-gray-50 cursor-pointer hover:bg-gray-100 hover:border-primary transition-all overflow-hidden relative">
                        <div id="previewContainer" class="absolute inset-0 w-full h-full">
                            <img id="imagePreview" src="<?php echo e(asset('storage/' . $slider->image)); ?>" class="w-full h-full object-cover">
                ...
                <p class="text-[10px] text-gray-400 text-center uppercase tracking-widest italic">Yeni bir görsel seçmezseniz mevcut görsel korunacaktır.</p>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="pt-8 border-t border-gray-50 flex items-center justify-end gap-4">
                ...
                <button type="submit" class="inline-flex items-center gap-3 px-12 py-4 bg-primary text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] hover:opacity-90 shadow-lg shadow-primary/25 transition-all">
                    DEĞİŞİKLİKLERİ KAYDET <i class="fa-solid fa-check-double ml-2"></i>
                </button>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\planify\resources\views/admin/sliders/edit.blade.php ENDPATH**/ ?>