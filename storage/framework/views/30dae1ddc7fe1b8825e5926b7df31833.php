...
<div class="min-h-screen bg-[#fcfcfc] text-gray-900 pb-24"
     x-data="{
         ...
         category: '<?php echo e(old('category', '')); ?>',
         cost: '<?php echo e(old('cost', '')); ?>',
         date: '<?php echo e(old('date', '')); ?>',
         location: '<?php echo e(old('location', '')); ?>',
         selectedCity: '<?php echo e(old('city_id', '')); ?>',
         selectedDistrict: '<?php echo e(old('district_id', '')); ?>',
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
                    ...
                    <div class="flex items-center gap-1.5 text-xs text-gray-400 font-medium">
                        ...
                        <span class="text-gray-600">/</span>
                        <a href="<?php echo e(route('etkinlikler.index')); ?>" class="hover:text-white transition-colors">Etkinlikler</a>
                        <span class="text-gray-600">/</span>
    ...
    <main class="max-w-7xl mx-auto px-6 -mt-8 relative z-20">
        ...
        <form action="<?php echo e(route('etkinlikler.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="description"
                                          ...
                                          class="w-full bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-[#ff5528] rounded-2xl p-5 text-sm font-medium text-gray-900 outline-none transition"><?php echo e(old('description')); ?></textarea>
                            </div>
                        </div>
                    </div>
