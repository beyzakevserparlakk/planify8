...
@section('title', 'İletişim & Sosyal Medya Ayarları')
@section('page_title', 'İletişim ve Sosyal Medya Yönetimi')
        ...
        <div x-show="activeTab === 'contact'" class="bg-[#16181e] rounded-3xl p-6 sm:p-8 border border-gray-800 shadow-xl space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="email"
                           name="contact_email"
                           value="{{ $settings['contact_email'] ?? 'destek@planify.com' }}"
                ...
                <div>
                    ...
                    <input type="text"
                           name="contact_phone"
                           value="{{ $settings['contact_phone'] ?? '+90 (212) 555 01 23' }}"
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ $settings['contact_whatsapp'] ?? '+90 (555) 123 45 67' }}"
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ $settings['contact_working_hours'] ?? 'Pazartesi - Cuma: 09:00 - 18:00' }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="contact_address"
                              ...
                              class="w-full bg-[#0f1115] border border-gray-700/80 rounded-2xl p-4 text-xs sm:text-sm font-bold text-white placeholder-gray-500 focus:outline-none focus:border-[#ff5528] transition">{{ $settings['contact_address'] ?? 'Levent, Büyükdere Cad. No:199, Şişli / İstanbul' }}</textarea>
                </div>

                {{-- İletişim Sayfası Kısa Açıklaması --}}
                <div class="md:col-span-2">
                    <label class="block text-xs font-black uppercase tracking-wider text-gray-300 mb-2">
                    ...
                    <textarea name="contact_description"
                              ...
                              class="w-full bg-[#0f1115] border border-gray-700/80 rounded-2xl p-4 text-xs sm:text-sm font-bold text-white placeholder-gray-500 focus:outline-none focus:border-[#ff5528] transition">{{ $settings['contact_description'] ?? 'Sorularınız, etkinlik ortaklıkları ve önerileriniz için bize dilediğiniz zaman ulaşabilirsiniz.' }}</textarea>
                </div>

                {{-- Google Maps Embed Linki / Iframe --}}
                <div class="md:col-span-2">
                    <label class="block text-xs font-black uppercase tracking-wider text-gray-300 mb-2">
                    ...
                    <input type="text"
                           ...
                           value="{{ $settings['contact_map_iframe'] ?? '' }}"
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="footer_about"
                              ...
                              class="w-full bg-[#0f1115] border border-gray-700/80 rounded-2xl p-4 text-xs sm:text-sm font-bold text-white placeholder-gray-500 focus:outline-none focus:border-[#ff5528] transition">{{ $settings['footer_about'] ?? 'Şehrin ritmini yakala, yeni deneyimler keşfet ve toplulukla buluş. En güncel konserler, tiyatrolar, atölyeler ve sosyal planlar tek bir platformda.' }}</textarea>
                </div>
            </div>
        </div>
